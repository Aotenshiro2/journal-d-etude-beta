...
export async function middleware(request: NextRequest) {
  ...
  // '/labo-boutons' : page JETABLE de comparaison visuelle (0.1.7). Aucune
  // donnée réelle. À retirer d'ici en même temps que la page.
  const publicPaths = ['/auth', '/api/health', '/guide', '/labo-boutons']
