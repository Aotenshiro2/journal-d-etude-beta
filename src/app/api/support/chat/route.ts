...
const APP_CONTEXT: Record<string, string> = {
  ...
  meltrade: `Le membre t'écrit depuis MelTrade (melaniechart.com), le site de Mélanie. MelTrade est une autre porte d'entrée vers le MÊME produit que le Live Club d'aoknowledge.com (sessions de live trading quotidiennes, abonnement mensuel sans engagement, communauté), présentée à une audience un peu différente. Ne présente pas MelTrade et le Live Club comme deux produits : un abonné MelTrade est membre du Live Club. Le visiteur ne connaît pas forcément l'univers AOK : reste sur le vocabulaire MelTrade sauf s'il en parle. Pour toute question d'abonnement, de paiement ou de résiliation, propose directement de parler à un humain.`,
}
