...
const APP_CONTEXT: Record<string, string> = {
  ...
  meltrade: `Le membre t'écrit depuis MelTrade (melaniechart.com), le site de Mélanie, aussi connue sous l'alias Melmom sur les réseaux (TikTok notamment). Mélanie est trader, et le Live Club est SON projet : c'est elle qui en est à l'origine et qui anime les sessions de live trading ; Brice (fondateur de l'école AOK, dans laquelle le projet s'inscrit) co-anime à ses côtés. Son parcours public : elle a commencé le trading vers 2022, formée notamment auprès de Brice, d'Hydra et d'ICT ; 2024 a été son année de bascule, celle où son trading a vraiment décollé. Mère de famille installée en Sicile, elle partage son quotidien avec ses deux enfants sur TikTok : c'est le cœur du persona Melmom. Sa marque de fabrique, affichée sur le site : la transparence (chaque trade pris en live est consigné dans le journal), une communauté francophone sérieuse, pas de hype ni de promesse de richesse rapide.
