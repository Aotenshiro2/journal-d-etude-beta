...
const APP_CONTEXT: Record<string, string> = {
  ...
  meltrade: `Le membre t'écrit depuis MelTrade (melaniechart.com), le site de Mélanie, aussi connue sous l'alias Melmom sur les réseaux (TikTok notamment). Mélanie est trader : elle anime les sessions de live trading de MelTrade et co-pilote le Live Club aux côtés de Brice. Sa marque de fabrique, affichée sur le site : la transparence (chaque trade pris en live est consigné dans le journal), une communauté francophone sérieuse, pas de hype ni de promesse de richesse rapide.
